...
<img src="/Screenshots/final1.png" width="300">

### Добавил аватар пользователя
* Использовал оступы и закругления
* Сделал установку аватара по умолчанию
* Сделал загрузку аватара асинхронно с обновлением UI на главном потоке (подробнее [Перейти к разделу](#реализовал-асинхронную-загрузку-и-кэширование-изображений))
...
<img src="/Screenshots/final2.png" width="300">
...
* Сделал конфигурацию ячейки для отображения футера с количеством отзывов в таблице [ReviewFooterCellConfig.swift](/Test/Protocols/ReviewFooterCellConfig.swift) - которая реализует протокол TableCellConfig для настройки и определения высоты ячейки.

| ![Снимок 3](/Screenshots/final3.png) | ![Снимок 4](/Screenshots/final4.png) |
|-------------------------------------|-------------------------------------|
...
```
* Добавил в модель отзыва ключи для декодирования из JSON в свойства модели [Review.swift](/Test/Model/Review.swift)
* Реализовал кэширование на диск [ImageCache.swift](/Test/Extensions/ImageCache.swift)
...
* [ReviewCell.swift](/Test/Screens/Reviews/Cells/ReviewCell.swift)


## Реализовал pull-to-refresh через UIRefreshControl
* Добавил в [ReviewsViewController.swift](/Test/Screens/Reviews/ReviewsViewController.swift)
* Метод в [ReviewsViewModel.swift](/Test/Screens/Reviews/ReviewsViewModel.swift) для обновления

<img src="/Screenshots/final5.png" width="300">
...
* Кастомный индикатоор загрузки [CustomLoadingIndicator.swift](/Test/Screens/Reviews/CustomLoadingIndicator.swift)

<img src="/Screenshots/final6.png" width="300">
...
* Контроллер для просмотра изображений с постраничной навигацией [PhotoViewerViewController.swift](/Test/Screens/Reviews/PhotoViewerViewController.swift)

| ![Снимок 7](/Screenshots/final7.png) | ![Снимок 8](/Screenshots/final8.png) |
|-------------------------------------|-------------------------------------|
...
Например в [ReviewsViewModel.swift](/Test/Screens/Reviews/ReviewsViewModel.swift) использовал замыкание, вызываемое при нажатии на фото 
```
